...
export class UserBusiness {
    ...
    public registerUser = async (registrationData: UsuarioModelo): Promise<string> => {
        try {
            ...
            if (tipoUsuario.toLowerCase() !== TipoUsuario.CLIENTE && tipoUsuario.toLowerCase() !== TipoUsuario.DISTRIBUIDORA) {
            ...
            const dataChecked = await this.userData.checkInfoExist(registrationData);
    ...
    public login = async (loginData: LoginData): Promise<string> => {
        try {
    ...
    public searchInformation = async (numPage: string, token: string): Promise<any> => {
        try {
    ...
    public getProfileInformation = async (token: string, idProfile: string): Promise<any> => {
        try {
